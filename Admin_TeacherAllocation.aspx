<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_TeacherAllocation.aspx.cs" Inherits="packages_Admin_TeacherAllocation" %>
...
<head runat="server">
    ...
    <title>FLEX</title>
    <link rel="stylesheet" href="CSS/Admin_TeacherAllocation.css" type="text/css"/>
</head>
<body>
            ...
            <div class="SideBar">
             ...
             <div class="Left">
                 ...
                 <div class="Bottom">
                     ...
                     <div class="Mid">
                         <asp:DropDownList class="bt1" ID="Course" runat="server" OnSelectedIndexChanged="DropDownSelect_SelectedIndexChanged" >  
                            <asp:ListItem Value="">Select</asp:ListItem>  
                        </asp:DropDownList> 
                     </div>
